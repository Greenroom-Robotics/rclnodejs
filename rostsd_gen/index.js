...
const DEFAULT_MODULE_NAME = 'rclnodejs';
...
async function generateAll({
  ...
  savePkgInfoAsTSD(pkgInfos, fd, moduleName);
...
function savePkgInfoAsTSD(pkgInfos, fd, moduleName) {
  const messagesMap = {
    string: 'string',
  };
  const servicesMap = {};
  ...
  fs.writeSync(fd, `declare module '${moduleName}' {\n`);
